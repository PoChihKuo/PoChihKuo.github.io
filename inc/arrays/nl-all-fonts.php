...
return $google_fonts = array('Lato','Playfair Display','PT Sans','PT Serif','Karma','Poiret One');
}
...
function the_gap_web_safe_fonts() {
	
		return $web_safe_font =  array(
